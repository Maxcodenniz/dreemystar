/*
  ...
  1. Changes
    - Add mux_stream_id column to store Mux stream identifier
    - Add mux_playback_id column to store Mux playback identifier
    - Create indexes for efficient querying
    
  2. Notes
    - These fields enable integration with Mux streaming service
    - Indexes improve query performance for stream-related lookups
*/
