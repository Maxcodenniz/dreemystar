-- Platform-wide toggle for ticket bundles (3/5-ticket bundles and "use credit" on Watch)
INSERT INTO public.app_config (key, value, description)
VALUES
  ('bundles_enabled', 'true'::jsonb, 'Enable ticket bundles platform-wide: Bundles page, cart bundle offer, and "Use 1 credit" on event pages')
ON CONFLICT (key) DO NOTHING;

-- Update update_app_config to include description for bundles_enabled
