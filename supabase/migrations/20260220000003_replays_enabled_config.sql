-- Platform-wide toggle for Replays (Replays page and replay purchase on Watch)
INSERT INTO public.app_config (key, value, description)
VALUES
  ('replays_enabled', 'true'::jsonb, 'Enable replays platform-wide: Replays page and watch-on-demand purchase')
ON CONFLICT (key) DO NOTHING;

-- Update update_app_config to include description for replays_enabled
