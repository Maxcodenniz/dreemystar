-- Platform-wide toggle: "Live + Replay" combined ticket on event Watch page (Stripe / mobile money where enabled)
INSERT INTO public.app_config (key, value, description)
VALUES
  (
    'live_replay_bundle_enabled',
    'true'::jsonb,
    'Show Live + Replay bundle payment option on event pages (requires replays to be meaningful; hide when disabled)'
  )
