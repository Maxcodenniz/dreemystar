-- Platform-wide toggle for "Are you an Artist?" application CTAs (Navbar + Home)
INSERT INTO public.app_config (key, value, description)
VALUES
  ('artist_application_enabled', 'true'::jsonb, 'Show "Are you an Artist?" application buttons in Navbar and on Home page')
ON CONFLICT (key) DO NOTHING;

-- Update update_app_config to include description for artist_application_enabled
